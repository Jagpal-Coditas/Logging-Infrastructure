...
namespace Coditas.Common.Logging
{
    public class GoogleCloudLoggingSink : BasePeriodicPushSink
    {
        ...
        public GoogleCloudLoggingSink(IGoogleCloudLoggingSinkOptions loggingSinkOptions, IEnumerable<ILogFormatter> logEventFormatters = null) : base("gcp", logEventFormatters)
        {
        ...
        private void WriteLogEntry(LogEvent logEvent)
        {
            ...
            foreach (var item in logEvent.LoggingFields)
            {
